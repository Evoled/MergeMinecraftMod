...
package net.mcreator.mcmerge.world.inventory;
...
import net.mcreator.mcmerge.init.McmergeModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class ConstruciontableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ConstruciontableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(McmergeModMenus.CONSTRUCIONTABLE_GUI, id);
