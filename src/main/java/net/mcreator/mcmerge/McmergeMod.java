...
@Mod("mcmerge")
public class McmergeMod {
	public static final Logger LOGGER = LogManager.getLogger(McmergeMod.class);
	public static final String MODID = "mcmerge";
